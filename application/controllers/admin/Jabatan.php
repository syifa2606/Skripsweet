...
class Jabatan extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert"><i class="fas fa-info-circle"></i> Data Jabatan <strong>Berhasil Ditambahkan.</strong></div>');
	...
	public function ubahjabatan()
	{
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert"><i class="fas fa-info-circle"></i> Data Jabatan <strong>Berhasil Diubah.</strong></div>');
		redirect('admin/jabatan');
	}
	...
	public function hapus($id)
	{
		...
		$this->session->set_flashdata('pesan', '<div class="alert alert-success" role="alert"><i class="fas fa-info-circle"></i> Data Jabatan <strong>Berhasil Dihapus.</strong></div>');
		redirect('admin/jabatan');
	}
}
